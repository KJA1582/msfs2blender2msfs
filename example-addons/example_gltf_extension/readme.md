...
Add a class named `gltf2ExportUserExtension` to your addon and instantiate an object of the class `io_scene_gltf2_msfs_kh.io.com.gltf2_io_extensions.Extension`
