...
def update_material(self, context):
    ...
    if self.msfs_material_type == "msfs_standard":  # Standard
        ...
        self.msfs_show_sss_color = (
            False  # Doesn't seem to be enabled in the 3DS Max plugin
        )
...
class msfs_material_properties(PropertyGroup):
    ...
    Material.msfs_material_type = EnumProperty(
        items=(
            ("NONE", "Disabled", ""),
    ...
    Material.msfs_uv_clamp_u = BoolProperty(
        name="UV Clamp U", default=msfs_material_default_values.msfs_uv_clamp_u
    )
    Material.msfs_uv_clamp_v = BoolProperty(
        name="UV Clamp V", default=msfs_material_default_values.msfs_uv_clamp_v
    )
    ...
    Material.msfs_normal_texture = PointerProperty(
        type=Image, name="Normal", update=functions.update_normal_texture
    )
    Material.msfs_emissive_texture = PointerProperty(
        type=Image, name="Emissive", update=functions.update_emissive_texture
    )
    ...
    Material.msfs_detail_normal_texture = PointerProperty(
        type=Image, name="Detail Normal", update=functions.update_normal_texture
    )
    Material.msfs_blend_mask_texture = PointerProperty(
        type=Image, name="Blend Mask", update=functions.update_blend_mask_texture
    )
    Material.msfs_wetness_ao_texture = PointerProperty(
        type=Image, name="Wetness AO", update=functions.update_wetness_ao_texture
    ...
    Material.msfs_dirt_texture = PointerProperty(
        type=Image, name="Dirt", update=functions.update_dirt_texture
