...
from io_scene_gltf2_msfs_kh_2024.io.com import gltf2_io_lights_punctual
from io_scene_gltf2_msfs_kh_2024.io.com import gltf2_io_debug

from io_scene_gltf2_msfs_kh_2024.blender.exp import gltf2_blender_gather_light_spots
    ...
    if emission_node is not None:
        if blender_lamp.type != "SUN":
            ...
            if result:
                ...
                emission_strength = quadratic_falloff_node.inputs[
                    "Strength"
                ].default_value / (math.pi * 4.0)
            else:
                gltf2_io_debug.print_console(
                    "WARNING",
...
def __gather_spot(
    ...
    if blender_lamp.type == "SPOT":
        return gltf2_blender_gather_light_spots.gather_light_spot(
            blender_lamp, export_settings
        )
    return None
...
def __gather_type(blender_lamp, _) -> str:
    return {"POINT": "point", "SUN": "directional", "SPOT": "spot"}[blender_lamp.type]
